...
// CHECK-NEXT:     }
// CHECK-NEXT:     %[[VAL_4:.*]] = ktdp.inter_tile_reduce(%[[VAL_2]]) consumer_tiles_per_group = #[[$ATTR_0]], identity(%[[VAL_1]] : tensor<1x64xf16>) : !ktdp.tile_future<(tensor<1x64xf16>), groups = #[[$ATTR_1]]> -> tensor<64xf16> {
...
// CHECK-NEXT:       ktdp.yield_partial %[[VAL_0]] : tensor<1x64xf16>
// CHECK-NEXT:     }
// CHECK-NEXT:     %[[VAL_4:.*]] = ktdp.inter_tile_reduce(%[[VAL_2]]) consumer_tiles_per_group = #[[$ATTR_3]], identity(%[[VAL_1]] : tensor<1x64xf16>) : !ktdp.tile_future<(tensor<1x64xf16>), groups = #[[$ATTR_1]]> -> tensor<64xf16> {
// CHECK-NEXT:     ^bb0(%[[VAL_5:.*]]: tensor<1x64xf16>, %[[VAL_6:.*]]: tensor<1x64xf16>):
// CHECK-NEXT:       %[[VAL_7:.*]] = linalg.add ins(%[[VAL_5]], %[[VAL_6]] : tensor<1x64xf16>, tensor<1x64xf16>) outs(%[[VAL_5]] : tensor<1x64xf16>) -> tensor<1x64xf16>
// CHECK-NEXT:       ktdp.yield_reduced %[[VAL_7]] : tensor<1x64xf16>
// CHECK-NEXT:     }
...
// CHECK-NEXT:     }
// CHECK-NEXT:     %[[VAL_4:.*]] = ktdp.inter_tile_reduce(%[[VAL_2]]) consumer_tiles_per_group = #[[$ATTR_2]], identity(%[[VAL_1]] : tensor<128x1x1x64xf16>) : !ktdp.tile_future<(tensor<128x1x1x64xf16>), groups = #[[$ATTR_4]]> -> tensor<128x1x64xf16> {
