...
struct PyAccessTileType
    : mlir::python::MLIR_BINDINGS_PYTHON_DOMAIN::PyConcreteType<
          PyAccessTileType,
          mlir::python::MLIR_BINDINGS_PYTHON_DOMAIN::PyShapedType> {
    ...
    c.def_static(
        ...
        [](std::vector<int64_t> shape, MlirType elementType,
           mlir::python::MLIR_BINDINGS_PYTHON_DOMAIN::DefaultingPyMlirContext
               context) {
          return PyAccessTileType(context->getRef(),
...
struct PyRuntimeArgType
    : mlir::python::MLIR_BINDINGS_PYTHON_DOMAIN::PyConcreteType<
          PyRuntimeArgType, mlir::python::MLIR_BINDINGS_PYTHON_DOMAIN::PyType> {
    ...
    c.def_static(
        ...
        [](MlirType underlyingType, std::optional<int64_t> granularity,
          ...
          return PyRuntimeArgType(
              context->getRef(),
              mlirKtdpRuntimeArgTypeGet(context->get(), underlyingType,
                                        granularity.value_or(-1),
                                        upperbound.value_or(-1)));
        },
        nb::arg("underlying_type"), nb::arg("granularity").none() = nb::none(),
  ...
  m.def(
      ...
      [](mlir::python::MLIR_BINDINGS_PYTHON_DOMAIN::DefaultingPyMlirContext
        ...
        for (auto handle : {
          ...
          if (load) mlirDialectHandleLoadDialect(handle, context_);
        }
      },
