//===- KTDPTypes.h - KTDP dialect types public header -----*- C++ -*-===//
//
//===----------------------------------------------------------------------===//
#ifndef KTIR_DIALECT_KTDP_KTDPTYPES_H_
#define KTIR_DIALECT_KTDP_KTDPTYPES_H_
...
#include "ktir/Dialect/KTDP/KTDPTypes.h.inc"
...
#endif // KTIR_DIALECT_KTDP_KTDPTYPES_H_
